    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('like', 'Like'), ('comment', 'Comment'), ('follow', 'Follow'), ('share', 'Share'), ('like_comment', 'Like Comment'), ('message', 'Message')], max_length=20)),
